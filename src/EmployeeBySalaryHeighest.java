...
public class EmployeeBySalaryHeighest {
    public static void main(String[] args) {
        ...
        Map<String, Employees> collect = empList.stream().collect(Collectors.groupingBy(Employees::getDeptName, Collectors.collectingAndThen(Collectors.toList(), list -> list.stream().sorted(Comparator.comparing(Employees::getSalary).reversed()).skip(1L).findFirst().orElseThrow())));
