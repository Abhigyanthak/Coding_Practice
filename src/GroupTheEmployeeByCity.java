...
public class GroupTheEmployeeByCity {
    public static void main(String args []){
        ...
        Map<String, List<Employees>> filteredEmployeeByCity = empList.stream().collect(Collectors.groupingBy(Employees::getCity));
        System.out.println(filteredEmployeeByCity);
    }
}
