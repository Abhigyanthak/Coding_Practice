...
public class EmployeeHighestSalaryForEachDepartment {
    public static void main(String[] args) {
        ...
        Map<String, Optional<Employees>> filteredEmployee = empList.stream().collect(Collectors.groupingBy(Employees::getDeptName, Collectors.maxBy(Comparator.comparing(Employees::getSalary))));
