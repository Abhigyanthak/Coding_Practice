...
public class EmployeesTopSalaryByDepartment {
    public static void main(String[] args) {
        ...
        Map<String, Optional<Employees>> collect = empList.stream().collect(Collectors.groupingBy(Employees::getDeptName, Collectors.maxBy(Comparator.comparing(Employees::getSalary))));
