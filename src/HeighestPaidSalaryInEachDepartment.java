...
public class HeighestPaidSalaryInEachDepartment {
    ...
    public static void main(String args []){
        ...
        Map<String, Optional<Employees>> filteredEmployees =  empList.stream().collect(Collectors.groupingBy(
                Employees::getDeptName, Collectors.maxBy(Comparator.comparing(Employees::getSalary))
        ));
