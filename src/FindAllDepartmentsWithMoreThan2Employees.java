...
public class FindAllDepartmentsWithMoreThan2Employees {
    public static void main(String[] args) {
        ...
        List<String> employees = empList.stream().collect(Collectors.groupingBy(Employees::getDeptName, Collectors.counting())).entrySet().stream().filter(e -> (Long)e.getValue() > 2L).map(Map.Entry::getKey).toList();
