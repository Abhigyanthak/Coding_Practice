...
public class SortEmployeeBasedOnDepartmentAndSalary {
    public static void main(String args[]){
        ...
        empList.stream().sorted(Comparator.comparing(Employees::getDeptName).thenComparing(Employees::getSalary)).collect(Collectors.toList());
