...
public class SeconhHeighestSalaryByGender {
    public static void main(String args []) {
        ...
        Optional<Employees> filteredEmployee = empList.stream().filter(e -> "M".equalsIgnoreCase(e.getGender()))
                .sorted(Comparator.comparing(Employees::getSalary).reversed()).skip(1)
                .findFirst();

        System.out.println(filteredEmployee.get().getSalary());
